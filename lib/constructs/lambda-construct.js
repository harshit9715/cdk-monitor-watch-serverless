...
const nodeFn = (that, fname, entry, layers, lambdarole, environment, nodeModules = [], externalModules = [], timeout = 3) => new lambda.Function(that, `${fname}Resource`, {
  code: lambda.Code.fromAsset(`lib/functions/${entry}`),
